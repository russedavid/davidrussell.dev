...
def otsc_page(step=0):
    return (
        ...
        Div(
            ...
            P("OTSC is an actively developed Mac desktop application. This page presents the product and its engineering; the source repository and recorded evaluations are currently private."),
